...
offset=colSums(exprs(islamEset)[9:nrow(exprs(islamEset)),])
gamlss.tr::gen.trun(par=0, family="NBI", name="ZeroTruncated", type="left", varying=FALSE)
paramsIslam=getDatasetZTNB(counts=islamHlp,design=model.matrix(~cellType), offset=offset)
```
...
weights=zeroWeightsLS(counts=simDataIslam$counts, design=design, maxit=200,plotW=TRUE)
